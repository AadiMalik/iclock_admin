            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="attendance.php" aria-expanded="false"><i class="fa fa-calendar"></i><span class="hide-menu">Attendance </span></a>
                        </li>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-flag"></i><span class="hide-menu"> Leave</span></a>
