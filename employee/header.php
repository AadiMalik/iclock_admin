...
<head>
   ...
   <link rel="stylesheet" href="../uses/bower_components/bootstrap-daterangepicker/daterangepicker.css"> 
    ...
    <link rel="stylesheet" href="../uses/bower_components/bootstrap-datepicker/distcss/bootstrap-datepicker.min.css">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="">
                        <!-- Logo icon -->                        
                        <b><img src="../images/<?php echo $row_header_logo['logo'];?>" alt="homepage" class="dark-logo" style="height: 10%;width: 50%;"/></b>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo($_SESSION["image"]!=NULL)?'<img  width="30" src="../admin/uploaded/employee/'.$_SESSION["image"].'"  >' :'' ;?>
                            &nbsp;
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="editprofile.php"><i class="ti-user"></i> Profile</a></li>
