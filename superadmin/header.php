...
<head>
   ...
   <link rel="stylesheet" href="../uses/bower_components/bootstrap-daterangepicker/daterangepicker.css"> 
    ...
    <link rel="stylesheet" href="../uses/bower_components/bootstrap-datepicker/dist/bootstrap-datepicker.min.css">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="">
                        <!-- Logo icon -->                        
                        <b><img src="../images/<?php echo $row_header_logo['logo'];?>" alt="homepage" class="dark-logo" style="width: 10%;"/></b>
