                    ...
                    <?php } ?>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
										<?php 
										$sql = "SELECT *, employees.eid AS empid FROM employees WHERE employees.admin_id='".$_SESSION['admin_id']."' AND employees.department_id='".$_SESSION['id']."'";
										$result = $conn->query($sql);
										while($row=mysqli_fetch_array($result)){
                        ...
                        $arow = $aquery->fetch_assoc();
                                        ?>
                                             <tr>
                                                ...
                                                <td><img src="<?php echo (!empty($row['image']))? '../admin/uploaded/employee/'.$row['image']:'../admin/uploaded/profile.jpg'; ?>" width="30px" height="30px"> </td>
