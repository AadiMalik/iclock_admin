	...
	if(isset($_POST['save'])){
		...
		if($query->num_rows < 1){
			...
			if($query->num_rows > 0){
				...
				$sql = "INSERT INTO attendance (employee_id, date, time_in, time_out, daytype,department_id,admin_id) VALUES ('$emp', '$date', '$time_in','$time_out','$day','".$_SESSION['id']."','".$_SESSION['admin_id']."')";
				if($conn->query($sql)){
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Daily Attendance</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Add Daily Attendance</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="post" id="multiple_select_form" >
                                       <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-employee">Employee</label>
                                            <div class="col-lg-6">
                                                <select class="form-control selectpicker" name="emp" id="val-employee" data-live-search="true">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6 date">
                                                <input type="date" class="form-control datepicker" id="datepicker_add" name="date" placeholder="Select Date" value="<?php echo date('Y-m-d'); ?>" readonly required>
                                            </div>
                                        </div>
										<div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-time_in">Time In </label>
                                            <div class="col-lg-6 bootstrap-timepicker">
                                                <input type="time" class="form-control " id="time_in" name="time_in" placeholder="Select Time In" required>
                                            </div>
                                        </div>
