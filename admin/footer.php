...
<?php
   ...
   <script src="../uses/js/lib/datatables/new_datatables-init.js"></script>
    ...
    <script src="../uses/js/lib/select2/select2.full.min.js"></script>
    <script>
        $("select").select2();
    </script>
    <!-- Security JS start -->
<!--<script src="../uses/js/f12_disable.js"></script>
<script src="../uses/js/disable_r_click.js"></script>
<script src="../uses/js/disable_everything.js"></script>
<script src="../uses/js/disable_ctrl_u.js"></script>
<script src="../uses/js/printscreen_disable.js"></script>-->
