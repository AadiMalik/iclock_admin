<?php
    ...
    if(isset($_POST['btn_update']))
    {
        ...
        $updated = mysqli_query($conn,"UPDATE tbl_todays_task SET 
                assign_name='".$_POST['assgn_name']."',description='".$_POST['desc']."',task_assign_date = '".$_POST['task_assign_date']."' WHERE id= '$id'");
     
        if($updated)
        {
?>
            <script type="text/javascript">
                window.location.href = "todays_task_list.php";
            </script>
<?php
        }
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Todays Assign Task</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Update Todays Assign Task</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php
                                        ...
                                        include('connect.php');
                                        $result = mysqli_query($conn,"SELECT * FROM tbl_todays_task WHERE id='".$_GET['task_id']."'");
                                        //print_r($result);
                                ...
                                <div class="form-validation">
                                    <form class="form-valide"  method="post" >
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-date">Task Assign date</label>
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" name="task_assign_date" value="<?php echo $row['task_assign_date']; ?>">
                                            </div>
                                        </div>
