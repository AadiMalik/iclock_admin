                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            $results = mysqli_query($conn,"SELECT * FROM tbl_task WHERE status = '0' && task_status='Incomplete' ORDER BY end_date ASC");
                                        ...
                                        ?>
                                            ...
                                            <tr><td colspan="4"><b><u>Todays Task</u></b></td><td></td></tr>
                                        <!-- Dispaly Todays Task -->
                                        <?php
                                            $results = mysqli_query($conn,"SELECT * FROM tbl_todays_task WHERE status = '0' && task_status='Incomplete' ORDER BY task_assign_date ASC");
