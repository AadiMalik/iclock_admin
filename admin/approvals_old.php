                            ...
                            <div class="card-body">								
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
					                    ...
					                    {
					                      $sql = "SELECT *,employees.department_id as department_id, employees.employee_id AS empid, leave_application.id AS attid,leave_application.status as leave_status FROM leave_application LEFT JOIN employees ON employees.eid=leave_application.employee_id WHERE employees.admin_id='".$_SESSION['id']."' AND department_status=1 ORDER BY leave_application.id DESC";
					                    }
