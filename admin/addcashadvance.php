<?php
	...
	if(isset($_POST['save'])){
		...
		if($query->num_rows < 1){
			...
			$employee_id = $row['eid'];
			$sql = "INSERT INTO cashadvance (employee_id, date_advance, amount) VALUES ('$employee_id', '$dt', '$amt')";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Cash Advance </h3> </div>
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-amt" name="amount" placeholder="Enter Cash Advance" required>
                                            </div>
                                        </div>
