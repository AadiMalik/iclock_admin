...
//session_start();
       ...
       if(isset($_GET['emp_id']))
       {
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql1 = mysqli_query($conn,"INSERT INTO tbl_todays_task(assign_name, task_id, description,eid,task_status,task_assign_date,status) VALUES ('".$_POST['assgn_name']."', '".$row_last_task['task_id']."', '".$_POST['desc']."','$eid','Incomplete','".date('Y-m-d')."','0')");
                 if($sql1)
                {
?>
                    <script>
                        window.location="todays_task_list.php";
                    </script>
<?php
                }
            }
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Assign Todays Task</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Assign Todays Task</li>
                    </ol>
                </div>
            </div>
