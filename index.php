...
<style>
  ...
  .mynews span {
    ...
    font: 16px 'Roboto', 'Raleway', Helvetica, Arial, sans-serif;
...
<body class="fix-header fix-sidebar" style="background-color: #000">
  ...
  <div id="main-wrapper">
    <div class="mynews blue">
      <span style="background-color: #FF0000;color:#fff">WARNING</span>
      <span class="text1">
        <marquee><b>
            <?php
            $i = 1;
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-right">
          ...
          <div class="col-lg-4" style="">
            ...
            <div class="login-content card" style="margin-top: 20px;opacity: 1;">
              <!--  <div class="justify-content-center" align="center" >
                      <img src="images/<?php //echo $row_header_logo['login_logo'];
                                        ?>" alt="homepage" class="dark-logo" style="height: 10%;width: 50%;"/> -->
              ...
              <div class="login-form">
                ...
                <form id="attendance">
                  ...
                  <div class="form-group" id="remark_div">
                    ...
                    <textarea type="text" class="form-control" id="remark" name="remark" style="height:208px"></textarea>
                  </div>
          ...
          <div class='col-lg-8'>
            <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
              <img src="images/login-bg1.png" style="height: 330px" />
            </div>
          </div>
        </div>
        ...
        <div>
          <div class="d-flex justify-content-end align-items-end">
            <p>&copy; 2025 .All rights reserved | Design by <a href="www.idamru.com">www.idamru.com</a></p>
          </div>
        </div>
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response.error) {
              ...
              $('button[name="signin"]').prop('disabled', true);
            } else {
              $('.alert').hide();
              $('button[name="signin"]').prop('disabled', false);
            }
          }
        });
      });
