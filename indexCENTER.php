...
<head>
    ...
    <link href="uses/css/style.css?v=1" rel="stylesheet">
                ...
                <div class="row justify-content-right">
                    ...
                    <div class="login-content card">
			               <div class="justify-content-center" align="center">
                               <img src="images/<?php echo $row_header_logo['login_logo'];?>" alt="homepage" class="dark-logo" style="height: 50%;width: 50%;"/>
							   <br>
                        ...
                        <div class="form-group row">
                                        ...
                                        <div id="full_day" style="display: none;">
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-12">
                                                  <input type="date" min="<?php echo date('Y-m-d') ?>" class="form-control"  name="from_date" id="from_date" >
<!-- ekariz fix
...
-->
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-12">
                                                  <input type="date" min="<?php echo date('Y-m-d') ?>" class="form-control"  name="to_date"  id="to_date" >
<!--
